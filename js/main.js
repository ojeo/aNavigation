...
$(function() {
        var bookmark = {
            data: [{
                ...
                box_shadow: '#5f6fe8',
                icon: 'img/synology.png',
            }, {
                name: 'Cnbeta',
                link: 'https://www.cnbeta.com.tw/',
                box_shadow: '#3776D2B8',
                icon: 'img/cnbeta.png',
            }, {
                name: '知乎',
                ...
                box_shadow: '#ed4b76',
                icon: 'img/bilibili2.png',
            }, {
                name: '樱花动漫',
                link: 'https://www.yhdmz.org/',
                box_shadow: '#ee7182',
                icon: 'img/yinghua.png',
            }, {
                name: '电影天堂',
